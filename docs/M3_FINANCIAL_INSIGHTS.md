...
| 비교집단 P90 | 341 | 284 | 13.3% |
| 비교집단 P95 | 179 | 155 | 6.4% |
...
고정 합집합 탐지율은 부처 중 101 18.6%, 회계유형 중 RESPONSIBLE_OPERATION_ACCOUNT 25.0%, 규모구간 중 Q1_SMALL 19.6%로 가장 높았습니다. P90은 전체 적격 행의 15.6%를 탐지하여 명목 10%보다 넓으므로 단독 주 기준으로는 방어하기 어렵습니다.
...
| BUDGET_RAPID_DECREASE | 88 | 81 | 0.3% | 비교집단 대비 예산 감소 사유를 확인할 후보 |
| PROGRAM_BUDGET_CONCENTRATION | 875 | 338 | 44.6% | 프로그램 신호가 소수 세부사업에 좌우될 가능성 |
| MULTIPLE_FINANCIAL_SIGNALS | 624 | 425 | 6.5% | 서로 다른 재정 신호가 동시에 나타나는 원문 검토 후보 |
...
**예산 급증·급감 방법 비교:** 비교집단·연도별 signed-log P05/P95는 각각 88행과 88행을 탐지했습니다. robust z-score, 절대 50%, winsorized 분포는 민감도 결과로 보존했습니다. 원본 증감률을 덮어쓰지 않으면서 규모비대칭을 줄이고 동년 비교집단 맥락을 유지하는 P05/P95를 주 후보로 권장합니다.
...
- 공식 단일 지원형태 3,249행만 지원형태 상대신호에 사용했고 복수·미확정은 전체 통계와 절대신호에 유지했습니다.
