...
- 기존 strict v1은 core의 47.5%만 남겼지만, ranking v2는 행을 유지하고 변수별 적격성을 제한해 core 6,130행을 보존했습니다.
- 프로그램 연결은 PARTIAL 5행, UNMATCHED 127행이며 이들의 집행률은 전체값처럼 해석하지 않습니다.
- 잠정 기준으로 연말 집중 신호는 832개 사업-연도, 반복 집행설명필요 사업은 177개입니다. 이는 낭비·실패 판정이 아니라 원문 확인 순서입니다.
...
- 결산 연결: 8,407행
- BLOCKING/NON_BLOCKING/INFORMATIONAL: 46/639/725행
- 재정수단 UNKNOWN: 3,100행
- 관계 수기검토 후보: 2,501행
- 집행률 100% 초과: 71행
...
회계유형-연도 집계는 16개 셀입니다. 일반·특별회계는 결산 예산현액, 기금은 VWFOEM2 예산현액을 지출계획현액 대응 분모로 사용했습니다. 분모가 없거나 0인 행은 집행률 분포에서 제외했습니다.
...
월별 패턴 최종 적격 사업-연도는 3,252행입니다. 잠정 연말 집중 기준은 4분기 비중 40% 이상 또는 12월 비중 20% 이상입니다.
...
strict v1의 core 본예산 포함률은 27.3%, ranking v2는 100.0%입니다. 고용노동부 기금 2022~2025년과 과학기술정보통신부 기금 2024년의 대표성 제한 경고를 유지합니다.

## 10. 주요 발견

- 반복 집행설명필요 사업 177개는 사례 원문 확인 후보입니다.
...
| project_size_vs_execution_rate | 6,114 | 16 | 0.044 |
| previous_execution_vs_current_budget_change | 2,401 | 3,729 | -0.008 |
| repeated_under_90_count_vs_budget_change | 4,084 | 2,046 | -0.028 |
